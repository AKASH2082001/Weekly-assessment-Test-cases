...
Guest Crime Report test
     ...
     sleep  3s
     input text  name:descrip  chain robbery had been occured on 9th cross street ayyapaakam chennai
     sleep  3s
...
User Registeration test
    ...
    sleep  1s
    input text  name:username  Ram
    sleep  1s
    input text  name:address  Thirupur
    sleep  1s
    input text  name:useremail  ${email}
    sleep  1s
    input text  name:userphone  9090909090
    sleep  1s
